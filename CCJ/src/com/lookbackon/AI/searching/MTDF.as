package com.lookbackon.AI.searching
{
	...
	public class MTDF
	{
		 ...
		 * MTD(f) gets a 'firstguess' value from the last iterative deepening stage. 
		 * By zooming in on the true MiniMax value with its minimal window calls, 
		 * it arrives at the same result as a normal AlphaBeta search, 
		 * but generally uses less nodes to find this value. 
		 * I read that for MTD to work, you have to store both upper and lower bounds in your hashtable 
		 * instead of just one value and bound type. 
		 * The idea is that MTD will often re-search a position with a different alpha-beta window, 
		 ...
		 * with the information that it also has a lower bound of 90. 
		 * @param position
		 * @param firstGuess
		 * @param depth
