package com.lookbackon.ccj.managers
{
	...
	public class EventManager extends EventDispatcher
	{
		 ...
		 * @throws	a RangeError warning if the number of listeners has exceeded the value in the class constant MAX_LISTENERS (Default is 1000).
		 */		
		public function addPermanenttListener ( 	type 				: String, 
													listener 			: Function, 
													useCapture 			: Boolean 		= false, 
													priority 			: int 			= 0,  
													useWeakReference 	: Boolean 		= false														
		 ...
		 * @see		#removeEventListener		removeEventListener
		 */
		public function removePermanentListener ( 	type 				: String, 
													listener 			: Function,
													listenerRef			: Object		= null,
													useCapture 			: Boolean 		= false														
		) : void
		 ...
		 */
		public function registerDispatcher ( 	dispatchingObj 	: IRegisteredDispatcher, 
		 ...
		 * @see		#registerDispatcher				registerDispatcher
		 */
		public function removeDispactchersByType ( 	
			type 				: String, 
		 ...
		 * @see		#registerDispatcher				registerDispatcher
		 */
		public function removeDispactchersByObj ( 
			obj 		: IRegisteredDispatcher, 
			isPermanent : Boolean 				=false
		) : Boolean
		{
		 ...
		 * @see		#removeEventListener		removeEventListener
		 */
		public function removeListenersByType ( 	type 			: String , 
													isPermanent		: Boolean = false													
		) : Boolean
		{
			var matchFound			: Boolean		= false;
		 ...
		 * 
		 */
		public function removeListenersByFunc ( 	func			: Function, 
													isPermanent 	: Boolean = false 													
		) : Boolean
		{
		...
		public function get 	dispatcherID	():uint { return _dispatcherID; }
		
		public function get 	listenerID		():uint { return _listenerID; }
